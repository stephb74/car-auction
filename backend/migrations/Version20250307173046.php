 ...
 */
final class Version20250307173046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE percentage_fee_rates (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fee_id INTEGER NOT NULL, vehicle_type_id INTEGER NOT NULL, rate DOUBLE PRECISION NOT NULL, min_amount DOUBLE PRECISION DEFAULT NULL, max_amount DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_91A5A778AB45AECA FOREIGN KEY (fee_id) REFERENCES fees (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
